...
from pimmslearn.plotting.errors import (
    get_data_for_errors_by_median,
    plot_errors_by_median,
)

TOP_N_COLOR_PALETTE = {
    "TRKNN": (0.20125317221201128, 0.6907920815379025, 0.47966761189275336),
...
def test_plot_errors_by_median(
    example_pred_loaded, feat_medians, expected_errors_binned
):
    ...
    pd.testing.assert_frame_equal(
        errors_binned, expected_errors_binned, check_dtype=False
    )
